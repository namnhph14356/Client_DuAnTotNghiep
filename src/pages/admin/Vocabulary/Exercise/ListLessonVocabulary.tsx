...
const ListLessonVocabulary = (props: Props) => {
        ...
        const columns2: ColumnsType<ExpandedDataType> = [
            ...
            },
            {
                ...
                key: "action", render: (text, record) => (
                    <Space align="center" size="middle">
                        <Button style={{ background: "#198754" }} >
                            <Link to={`/manageDay/vocabulary/${record._id}/editExerciseAnswer`} >
                                <span className="text-white">Sửa</span>
                            </Link>
    ...
    return (
        <div>
            ...
            <Button type='primary' className='mb-8' >
                <Link to={`/manageDay/vocabulary/addExercise`}>Thêm câu hỏi</Link>
            </Button>
