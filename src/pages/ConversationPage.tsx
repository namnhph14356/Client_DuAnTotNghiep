    ...
    <div className='conversation__page'>
      <div className="main__conversation">
        ...
        <div className="nav__speaking">
          ...
          <div>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/conversation/listenWrite`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-book mr-2"></i> Bài tập
              </button>
            </NavLink>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/conversation/listenRead`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-comment mr-2"></i>Nghe và đọc
              </button>
            </NavLink>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/conversation/note`} className="text-black" >
              <button className="btn__comment__speaking ">
