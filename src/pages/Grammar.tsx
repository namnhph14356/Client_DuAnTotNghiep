    ...
    <div className="grammar__page">
      <div className="main__grammar__page">
        ...
        <div className="nav__speaking">
          ...
          <div>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/grammar/lesson`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-book"></i> Bài học
              </button>
            </NavLink>

            <NavLink to={`/learning/${dayId}/detailLearning/${id}/grammar/exercise`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-pen-to-square mr-1"></i>Bài tập
              </button>
            </NavLink>

            <NavLink to={`/learning/${dayId}/detailLearning/${id}/grammar/note`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-notes-medical"></i> Ghi chú
              </button>
            </NavLink>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/grammar/questionAndAnswer`} className="text-black" >
              <button className="btn__comment__speaking ">
