...
import ModalWelcomwe from "../components/ModalWelcomwe";
            ...
            <div className="box">
              <div className="row">
                <div className="col social__custom">
                  <img src={"../../assets/image/image 7.png"} width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 8.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox2"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 9.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox3"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 10.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox4"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 11.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox5"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 12.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox6"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 14.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox7"
                    className="_checkbox"
                ...
                <div className="col social__custom">
                  <img src="../../assets/image/image 15.png" width={140} />
                  <input
                    type="checkbox"
                    id="_checkbox8"
                    className="_checkbox"
            ...
            <div className="box">
              <div className="row">
                <div className="col reason__custom">
                  <img src="../../assets/image/image 17.png" width={140} />
                  <input
                    type="checkbox"
                    id="_reason"
                ...
                <div className="col reason__custom">
                  <img src="../../assets/image/image 18.png" width={140} />
                  <input
                    type="checkbox"
                    id="_reason2"
                    value="Giao tiếp"
                ...
                <div className="col reason__custom">
                  <img src="../../assets/image/image 19.png" width={140} />
                  <input
                    type="checkbox"
                    id="_reason3"
                    value="Xem phim"
                ...
                <div className="col reason__custom">
                  <img src="../../assets/image/image 20.png" width={140} />
                  <input
                    type="checkbox"
                    id="_reason4"
                    value="Thi cử"
