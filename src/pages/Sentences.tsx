      ...
      <div className="main__grammar__page">
        ...
        <div className="nav__speaking">
          ...
          <div>
            ...
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/sentences/lesson`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-book"></i> Bài học
              </button>
            </NavLink>

            <NavLink to={`/learning/${dayId}/detailLearning/${id}/sentences/exercise`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-pen-to-square mr-1"></i>Bài tập
              </button>
            </NavLink>

            <NavLink to={`/learning/${dayId}/detailLearning/${id}/sentences/exam`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-pen-to-square mr-1"></i>Thi Oral
              </button>
            </NavLink>

            <NavLink to={`/learning/${dayId}/detailLearning/${id}/sentences/note`} className="text-black" >
              <button className="btn__comment__speaking ">
                <i className="fa-solid fa-notes-medical"></i> Ghi chú
              </button>
            </NavLink>
            <NavLink to={`/learning/${dayId}/detailLearning/${id}/sentences/questionAndAnswer`} className="text-black" >
              <button className="btn__comment__speaking ">
