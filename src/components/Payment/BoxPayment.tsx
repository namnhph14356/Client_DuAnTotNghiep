  ...
  return (
    <div className="box__buy__source">
      ...
      <div className="text-center">
        {auth.pay == 1 ? <span className='font-bold text-[#ff9933]'>Đã thanh toán</span> : <button className="p-1 px-3 bg-red-500 rounded text-white hover:bg-white border-[1px] border-red-600 font-bold hover:text-red-500" onClick={() => handlonClick()}>Thanh toán</button>}
