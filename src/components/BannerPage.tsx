...
const BannerPage = () => {
  return (
    <div>
      ...
      >
        <SwiperSlide>
          <section className="swiper-slide slide" style={{ backgroundImage: "url(https://res.cloudinary.com/chanh-thon/image/upload/v1670926803/home-slide-1_dkeweb.jpg)", backgroundRepeat: "no-repeat", backgroundSize:"cover" }}>
        ...
        <SwiperSlide>
          <section className="swiper-slide slide" style={{ backgroundImage: "url(https://res.cloudinary.com/chanh-thon/image/upload/v1670926803/home-slide-2_lxo4jk.jpg)", backgroundRepeat: "no-repeat", backgroundSize:"cover" }}>
            <div className="content-slide">
        ...
        <SwiperSlide>
          <section className="swiper-slide slide" style={{ backgroundImage: "url(https://res.cloudinary.com/chanh-thon/image/upload/v1670926803/home-slide-3_rjjowb.jpg)", backgroundRepeat: "no-repeat", backgroundSize:"cover" }}>
            <div className="content-slide">
